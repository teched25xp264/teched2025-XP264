...
| Admin Workflow (cluster-wide) | Student Workflow (namespaced)| Data Collection Workflow (namespaced) 
| :---------  | --------- | :--------- 
| [cluster-wide--admin](../../../../actions/workflows/k8s-context-admin.yml) | [namespaced--student](../../../../actions/workflows/k8s-context-student.yml)| [ k8s-data-context-student](../../../../actions/workflows/k8s-data-context-student.yml) 
